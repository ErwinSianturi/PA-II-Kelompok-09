    ...
    <div class="admin-dashboard">
        <div class="container py-4">
            ...
            <div class="row mb-4">
                ...
                <!-- New Transaction Money Card -->
                <div class="col-md-3 mb-3">
                    <div class="stats-card bg-warning text-white">
                        <div class="stats-card-body">
                            <div class="stats-card-icon"><i class="fas fa-dollar-sign"></i></div>
                            <div class="stats-card-content">
                                <h5 class="stats-card-title">Total Transactions</h5>
                                <p class="stats-card-value">Rp{{ number_format($jlh_kotor, 0, ',', '.') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                    <div class="card shadow-sm">
                        <div class="card-header bg-white d-flex justify-content-between align-items-center border-bottom">
                            <h3 class="card-title mb-0 text-primary">Transaksi</h3>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <p class="text-muted mb-0">Total Pendapatan Kotor (100% dari semua transaksi):</p>
                                <span
                                    class="badge bg-danger text-white fs-5">Rp{{ number_format($jlh_kotor, 0, ',', '.') }}</span>
