        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white p-0">
                <ul class="nav nav-tabs nav-fill" id="profileTabs" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link px-4 py-3" id="create-tab" data-bs-toggle="tab"
                                data-bs-target="#create" type="button" role="tab">
                            <i class="fas fa-briefcase me-2"></i>Pengalaman Kerja
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link px-4 py-3" id="friends-tab" data-bs-toggle="tab"
            ...
            <div class="card-body p-4">
                <div class="tab-content" id="profileTabsContent">
                    ...
                    <div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="about-tab">
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-4 mt-md-0">
                                <div class="card shadow-sm h-100">
                                    <div class="card-header bg-light">
                                        <h5 class="mb-0"><i class="fas fa-map-marked-alt me-2"></i>Informasi Lokasi</h5>
                                    </div>
                                    <div class="card-body">
                                        <table class="table table-borderless">
                                            <tr>
                                                <th width="40%"><i class="fas fa-map me-2"></i>Provinsi</th>
                    ...
                    <div class="tab-pane fade" id="create" role="tabpanel" aria-labelledby="create-tab">
                        ...
                        @if ($pengalamanKerja->isEmpty())
                            <div class="alert alert-info">
                                <i class="fas fa-info-circle me-2"></i>Anda belum memiliki pengalaman kerja. Silakan tambahkan pengalaman kerja Anda.
                            </div>
                        @else
                            <div class="row">
                                        ...
                                        <div class="card shadow-sm h-100">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <span class="badge {{ $kerja->is_current ? 'bg-success' : 'bg-secondary' }}">
                                                ...
                                                <p class="text-muted mb-2">
                                                    <i class="fas fa-map-marker-alt me-2"></i>{{ $kerja->city }}, {{ $kerja->country }}
                                                </p>
                                                ...
                                                @if($kerja->description)
                                                    <div class="mb-3">
                                                        <p class="text-muted small">{{ Str::limit($kerja->description, 100) }}</p>
                                                    </div>
                                                @endif

                                                <div class="d-flex">
                                                    <a href="{{ route('pengalaman.edit', $kerja->id) }}" class="btn btn-sm btn-outline-warning me-2">
                                                        <i class="fas fa-edit me-1"></i>Edit
                                                    </a>

                                                    <form action="{{ route('pengalaman.destroy', $kerja->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                    ...
                    <div class="tab-pane fade" id="friends" role="tabpanel" aria-labelledby="friends-tab">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h4 class="mb-0"><i class="fas fa-users me-2"></i>Koneksi Saya</h4>
                            <button class="btn btn-outline-primary">
                                <i class="fas fa-search me-2"></i>Temukan Teman
                            </button>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-lg-3 mb-4">
                                <div class="card shadow-sm text-center h-100">
                                    <div class="card-body">
                                        <img src="{{ asset('images/friend1.jpg') }}" class="rounded-circle mb-3"
                                            style="width: 80px; height: 80px; object-fit: cover;" alt="Friend 1">
                                        <h5 class="card-title mb-1">Jane Smith</h5>
                                        <p class="text-muted small mb-2">Software Developer</p>
                            ...
                            <!-- Placeholder for more friends -->
                            <div class="col-12 mt-3">
                                <div class="alert alert-info">
                                    <i class="fas fa-info-circle me-2"></i>Fitur koneksi masih dalam pengembangan.
                                </div>
                            </div>
                        </div>
                    </div>
