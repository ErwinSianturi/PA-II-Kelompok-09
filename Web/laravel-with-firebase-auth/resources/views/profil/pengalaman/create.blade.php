...
@section('content')
    <div class="container">
        <h1>Create Pengalaman Kerja</h1>

        <!-- Form to Create Pengalaman Kerja -->
        <form action="{{ route('pengalaman_kerja.store') }}" method="POST" id="experienceForm">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" name="job_function" id="job_function" class="form-control" required>
            </div>
            ...
            <button type="submit" class="btn btn-success">Create Pengalaman Kerja</button>
        </form>
    </div>
