...
<body class="bg-white text-black">
    ...
    <section class="px-20 py-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-5 p-6 max-w-7xl mx-auto">

          <!-- Card Kebersihan -->
          <div class="flex flex-col md:flex-row justify-between items-center px-8 py-3 bg-[#F8F8FB] w-full h-auto rounded-[30px]"
               style="
                 border: 1px solid rgba(0, 0, 0, 1);
                 box-shadow: 0 20px 35px rgba(0, 0, 0, 0.1), 0 8px 3px rgba(0, 0, 0, 0.85);
               ">
        
            <!-- Kiri: Teks -->
            <div class="flex flex-col basis-1/2 gap-2">
              <h3 class="text-white bg-purple-600 px-4 py-1 rounded-lg text-3xl w-fit font-normal mb-6">Kebersihan</h3>
          ...
          <div class="p-6 bg-white rounded-[30px] border shadow-lg flex flex-col md:flex-row gap-4 w-full max-w-7xl mx-auto h-auto">
            <!-- Teks -->
