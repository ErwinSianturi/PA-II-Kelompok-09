        ...
        <div class="card-header bg-white p-0">
            <ul class="nav nav-tabs nav-fill" id="jobTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active px-4 py-3" id="posted-tab" data-bs-toggle="tab" data-bs-target="#posted" type="button" role="tab">
                        <i class="fas fa-clipboard-list me-2"></i>Postingan
                        <span class="badge bg-primary ms-2">{{ count($postedJobs) }}</span>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link px-4 py-3" id="taken-tab" data-bs-toggle="tab" data-bs-target="#taken" type="button" role="tab">
                        <i class="fas fa-check-circle me-2"></i>Apply Diterima
                        <span class="badge bg-success ms-2">{{ count($takenJobs) }}</span>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link px-4 py-3" id="ongoing-tab" data-bs-toggle="tab" data-bs-target="#ongoing" type="button" role="tab">
                        ...
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="fw-bold">Rp{{ number_format($job->harga_pekerjaan, 0, ',', '.') }}</span>
                                    </td>
                                    <td>
